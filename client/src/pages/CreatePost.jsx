...
<div>
        ...
        <p className="mt-2 text=[#666e75] text-[16px] max-w-[500px]">
         Create imaginative visually stunning images through by AI and share with community.
          </p>       
       </div>
       <form className="mt-16 max-w-3xl " onSubmit={handleSubmit}>
         ...
         <div className='mt-5 flex gap-5'>
            ...
            text-center hover:bg-green-600 transition-colors " 
            >
          ...
          <div className="mt-10 ">
            <p className="mt-2 text-[#666e75] text-[14px] ">
              Once you click generate, your image will be created and you can share it with the community.
            </p>
            <button
            type="submit"
